...
#'
#' @export
select <- function(stid=NULL,param=NULL,lon=NULL,lat=NULL,alt=NULL,cntr=NULL,...) UseMethod("select")

#' @export
select.station <- function(stid=NULL, param=NULL, lon=NULL, lat=NULL, alt=NULL, cntr=NULL, src=NULL,
  ..., file="station.meta.rda", path="esd/data", silent=FALSE, verbose=FALSE) {
